...
public class AddIncomeActivity extends AppCompatActivity {
    ImageView ivBack;
    TextView tvLabel;
    TextInputEditText etTitle, etIncome, etDetails;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (previousModel != null) {
            tvLabel.setText("Update Income");
            btnAdd.setText("Update");
            btnDelete.setVisibility(View.VISIBLE);
            etTitle.setText(previousModel.getTitle());
            etIncome.setText(previousModel.getAmount());
            ...
            public void onClick(View view) {
                if (isValidated()) {
                    ...
                    if (previousModel != null) {
                        ...
                        incomeExpenseModel = new IncomeExpenseModel(title, amount, details, getCurrentDateTime(), "income");
    ...
    private Boolean isValidated() {
        ...
        amount = etIncome.getText().toString().trim();
